...
const colaboradores = [
  ...
  { nombre: "Daniel Carmona", LinkedIn: "@danielcarmonagilibert" },
];

console.log("Esta es la lista de colaboradores en este proyecto");
colaboradores.forEach((colaborador) => {
  let redSocial = Object.keys(colaborador)[1];
  let usuario = Object.values(colaborador)[1];
  console.log(`${colaborador.nombre} - ${redSocial} --> ${usuario}`);
});
